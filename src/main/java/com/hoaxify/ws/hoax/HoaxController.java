...
public class HoaxController {
    ...
    //@PageableDefault(sort = "id", direction = Sort.Direction.DESC) verileri getiitriken en son ekleneni listenin en başına alacak
    @GetMapping("/hoaxes")
    ...
    ResponseEntity<?> getHoaxesRelative(@PageableDefault(sort = "id", direction = Sort.Direction.DESC) Pageable page,
        ...
        if (direction.equals("after")) {
            ...
            //Hoax'ı HoaxVM'e çevirir Liste olarak döner
